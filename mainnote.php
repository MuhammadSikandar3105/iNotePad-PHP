...
<body
    class="body <?php echo isset($_SESSION['theme']) && $_SESSION['theme'] == 'light' ? 'light-mode' : 'dark-mode'; ?>">
                ...
                <form class="d-flex" role="search">
                    <div class="dropdown text-end">
                        ...
                        <ul class="dropdown-menu text-small" style="">
                            ...
                            <li><a id="themeToggleBtn"><i
                            class="fa-solid <?php echo isset($_SESSION['theme']) && $_SESSION['theme'] == 'dark' ? 'fa-toggle-off' : 'fa-toggle-on'; ?>"></i><span class="mx-1" style="cursor:pointer;">Theme</span></a></li>
                            <li>
